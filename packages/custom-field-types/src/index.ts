 ...
 * line2 and state are optional; country is a two-letter ISO 3166-1 code. Because
 * it is one zod object, invalid sub-fields surface per path (the caller can point
 * at `postal_code` specifically) with no bespoke composite handling.
 */
